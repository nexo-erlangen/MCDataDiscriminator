...
def gradient_penalty_loss(y_true, y_pred, averaged_batch, penalty_weight):
    ...
    # print averaged_batch[0]
    # print averaged_batch[1]
    # print y_pred
    # print averaged_batch
    #
    gradients = []
    ...
    # print gradient_penalty_0
    # print gradient_penalty_1
...
generator_training.compile(optimizer=Adam(0.000001, beta_1=0.5, beta_2=0.9, decay=0.0), loss=[wasserstein_loss])
...
critic_training.compile(optimizer=Adam(0.000001, beta_1=0.5, beta_2=0.9, decay=0.0), loss=[wasserstein_loss, wasserstein_loss, gradient_penalty])
