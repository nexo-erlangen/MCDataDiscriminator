...
output_dir = '/home/vault/capm/mppi060h/MCDataDiscriminator/TrainingRuns/WGAN_original/'
...
def generate_images(generator_model, output_dir, epoch):
    ...
    outfile = os.path.join(output_dir, 'epoch_{}.pdf'.format(epoch))
...
# args = parser.parse_args('/home/vault/capm/mppi060h/MCDataDiscriminator/TrainingRuns/WGAN_original/')
...
def plot_loss(loss, log_dir=".", name=""):
    ...
    fig.savefig(output_dir + '/%s_Loss.png' % name, dpi=120)
    plt.close('all')
...
for epoch in range(100):
    ...
    for i in range(int(X_train.shape[0] // (BATCH_SIZE * TRAINING_RATIO))):
        ...
        # generator_loss.append(generator_model.train_on_batch(np.random.rand(BATCH_SIZE, 100), positive_y)) #original positive_y
    ...
    plot_loss(loss=generator_loss, name="generator")
    plot_loss(loss=discriminator_loss, name="discriminator")