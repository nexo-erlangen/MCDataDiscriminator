...
path_load = '/home/vault/capm/mppi060h/MCDataDiscriminator/TrainingRuns/2019_06/2019_06_06-12_49_02/GAN/'
...
path_save = "/home/vault/capm/mppi060h/MCDataDiscriminator/plots_WGAN_3D"
...
for i in range(batch_size):
    ...
    for j in range(MC_input.shape[2]):
        ...
        plt.xlim(0, 350)
        plt.subplot(324)
        plt.plot(generated_images[i, 0][j] + j * 20, color=color, linewidth=0.5)
        plt.yticks([])
        ax2 = plt.twinx()
        ...
        plt.xlim(0, 350)
        plt.subplot(326)
        plt.plot(np.subtract(generated_images[i, 0][j], MC_input[i, 0][j]) + j * 20, color=color,
                 linewidth=0.5)
        plt.yticks([])
        ...
        plt.xlim(0, 350)
        plt.subplot(323)
        plt.plot(generated_images[i, 1][j] + j * 20, color=color, linewidth=0.5)
        plt.ylabel('Channel')
        plt.xticks([])
        plt.yticks([])
        plt.xlim(0, 350)
        plt.subplot(325)
        plt.plot(np.subtract(generated_images[i, 1][j], MC_input[i, 1][j]) + j * 20, color=color,
                 linewidth=0.5)
        plt.ylabel('Channel')
        plt.xlabel('Time [$\mu$s]')
        plt.yticks([])
