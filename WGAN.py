...
def make_discriminator():
    ...
    model = Sequential()
    model.add(Convolution2D(32, (5, 5), padding='same', input_shape=(76, 350, 1)))
    model.add(LeakyReLU())
    model.add(Convolution2D(32, (5, 5), kernel_initializer='he_normal', strides=[2, 2]))
    model.add(LeakyReLU())
    ...
    for epoch in range(50):
        ...
        for i in range(train_steps_per_epoch):
            ...
            if i % 100 == 0:
                ...
                plt.plot(epoch_counter_fine, discriminator_loss, label='discriminitive loss')
