...
from keras.layers import ReLU, GlobalMaxPooling2D, Dropout, Activation, MaxPooling2D, Dropout, GlobalAveragePooling2D, Reshape
...
def train_for_n(EPOCHS, BATCH_SIZE):
    ...
    for epoch in range(EPOCHS):
        ...
        generator_training.save_weights(path_save + "GAN/GAN_weights-" + str(epoch) + ".hdf5")
